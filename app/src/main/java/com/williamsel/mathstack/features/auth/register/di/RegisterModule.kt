package com.williamsel.mathstack.features.auth.register.di

import com.williamsel.mathstack.features.auth.register.data.datasource.api.RegisterApi
import com.williamsel.mathstack.features.auth.register.data.repositories.RegisterRepositoryImpl
